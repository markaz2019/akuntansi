<div class="kotak">
	<br>
	<center>
		<h1 class=" text-muted">LAPORAN TELKOMSEL</h1>
	</center>
	...
	<div id="myTabContent" class="tab-content tab-space">
		<div class="tab-pane fade active show" id="harian"><br />
			<form action="<?= base_url('p/harian_supplier_telkomsel'); ?>" method="POST">
		...
		<div class="tab-pane fade" id="periode"><br />
			<form action="<?= base_url('p/periode_supplier_telkomsel'); ?>" method="POST">
				<div class="form-group">
